...
void MyCamera::mousePressEvent(QMouseEvent *event)
{
...
void MyCamera::lockStatusChanged(QCamera::LockStatus status, QCamera::LockChangeReason reason)
{
...
void MyCamera::imageCaptured(int id, const QImage &preview)
{
    showViewFinder = false;
    m_focusing = false;
...
void MyCamera::error(QCamera::Error e)
{
    switch (e) {
    ...
    {
        QMessageBox::warning(this, "Camera", "General Camera error");
        break;
    }
    case QCamera::InvalidRequestError:
    {
        QMessageBox::warning(this, "Camera", "Camera invalid request error");
        break;
    }
    case QCamera::ServiceMissingError:
    {
        QMessageBox::warning(this, "Camera", "Camera service missing error");
        break;
    }
    case QCamera::NotSupportedFeatureError :
    {
        QMessageBox::warning(this, "Camera", "Camera not supported error");
        break;
    }
    };
}

void MyCamera::updateVideo()
{
    if (showViewFinder) {
        repaint();
    }
